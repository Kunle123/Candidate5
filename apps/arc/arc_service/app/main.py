...
def parse_cv_with_ai_chunk(text):
    ...
    prompt_instructions = (
        ...
        "  Use the dates and job title to help group/merge entries that belong to the same work experience, even if they appear in different sections or different CVs.\n"
        "  Format the description so that each complete sentence appears on a new line.\n"
